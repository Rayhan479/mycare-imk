            ...
            <div class="flex flex-col">
                        ...
                        <div class="w-full md:w-auto md:block">
                            ${
                                ...
                                <div class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
                                    ...
                                    : `
                                <a href="#/login" class="block w-full md:w-auto text-center text-white bg-linear-to-l from-[#00C6FF] to-[#0084FF] hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5">Login</a>`
                            }
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between pl-4 md:pl-8 lg:pl-20 py-10 md:py-20 gap-10">
                    <div class="flex flex-col w-full lg:w-1/2 space-y-6">
                        <h1 class="font-bold text-4xl sm:text-3xl lg:text-4xl leading-snug">
                            Teman Digital untuk   <span class="bg-linear-to-l from-[#00C6FF] to-[#0084FF] bg-clip-text font-bold block mt-2 text-transparent">Kesehatan Mentalmu</span>
                            
                        </h1>
                        <p class="text-base md:text-lg lg:text-xl text-gray-700">
                            Mulai dari curhat ringan hingga konsultasi profesional, kami hadir sebagai ruang aman yang personal dan penuh empati-didukung oleh AI yang benar-benar peduli.
                        </p>
                    </div>
                ...
                <div class="flex flex-col items-center px-4 py-0 text-lg md:text-[20px] font-semibold bg-linear-to-t from-[#00C6FF] to-[#0084FF] rounded-lg mx-4 md:mx-10 lg:mx-20">
                    <h2 class="text-center mb-20 mt-10 text-white text-2xl">Masih Bingung Tentang MyCare?</h2>
                    <div class="flex flex-col lg:flex-row w-full gap-10 items-start justify-center">
                        <div class="w-full lg:w-1/2 flex justify-center">
                            <img src="/images/clinic-banner-callus-removebg-preview.png" alt="FAQ Image" class="w-full object-contain max-w-sm"/>
                        </div>
                ...
                <div class="mt-10 md:mt-20 px-4 md:px-10 lg:px-20 pb-10 md:pb-20">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="p-6 shadow-lg bg-white rounded-lg border border-gray-200 space-y-4 transition hover:shadow-xl hover:-translate-y-1">
                            <div class="flex items-center justify-between"><h2 class="text-xl font-semibold">Percakapan Empatik</h2><i class="bg-linear-to-l from-[#00C6FF] to-[#0084FF] bg-clip-text text-transparent text-2xl fas fa-comments"></i></div>
                        ...
                        <div class="p-6 shadow-lg bg-white rounded-lg border border-gray-200 space-y-4 transition hover:shadow-xl hover:-translate-y-1">
                            <div class="flex items-center justify-between"><h2 class="text-xl font-semibold">Analisis Mood & Insight</h2><i class="bg-linear-to-l from-[#00C6FF] to-[#0084FF] bg-clip-text text-transparent text-2xl fas fa-chart-line"></i></div>
                        ...
                        <div class="p-6 shadow-lg bg-white rounded-lg border border-gray-200 space-y-4 transition hover:shadow-xl hover:-translate-y-1">
                            <div class="flex items-center justify-between"><h2 class="text-xl font-semibold">Rekomendasi Personal</h2><i class="bg-linear-to-l from-[#00C6FF] to-[#0084FF] bg-clip-text text-transparent text-2xl fas fa-lightbulb"></i></div>
                        ...
                        <div class="p-6 shadow-lg bg-white rounded-lg border border-gray-200 space-y-4 transition hover:shadow-xl hover:-translate-y-1">
                            <div class="flex items-center justify-between"><h2 class="text-xl font-semibold">Privasi & Keamanan</h2><i class="bg-linear-to-l from-[#00C6FF] to-[#0084FF] bg-clip-text text-transparent text-2xl fas fa-shield-alt"></i></div>
                ...
                <div class="mt-10 md:mt-20 px-4 md:px-10 lg:px-20 pb-10 md:pb-20">
                    <div class="flex flex-col items-center text-center w-full max-w-4xl mx-auto space-y-4 mb-8 md:mb-12">
                        ...
                        <span class="text-sm md:text-base lg:text-lg font-semibold text-gray-700">Nikmati berbagai kemampuan AI dari myCare yang dirancang untuk mengurangi waktu pada pekerjaan administratif dan meningkatkan fokus pada perawatan pasien.</span>
                    </div>
                    <div class="h-auto sm:h-[400px] md:h-[500px] lg:h-[541px] bg-[#E4E4E7] rounded-xl px-4 sm:pl-8 py-6">
                        <div class="flex flex-col sm:flex-row items-center justify-between h-full gap-4">
                            <div class="flex flex-col items-start w-full sm:max-w-[300px] space-y-3 md:space-y-4 text-center sm:text-left">
                                <h1 class="text-xl md:text-2xl font-bold">MyCare Berbasis AI.</h1>
                                <span class="text-gray-700 text-xs sm:text-sm leading-relaxed">Terobosan baru di dunia kesehatan gigi yang menghubungkan teknologi AI dan dunia medis.
Dengan pendekatan AI-Deep Learning, pengklasifikasian kerusakan gigi dapat dilakukan dengan lebih cepat dan tepat.</span>
                            </div>
                ...
                <div class="mt-16 px-6 md:px-20">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                         <div class="bg-white border border-gray-200 rounded-xl shadow-md p-6 flex items-start space-x-4">
                            <div class="bg-blue-100 bg-linear-to-t from-[#00C6FF] to-[#0084FF] bg-clip-text text-transparent p-3 rounded-full mt-1"><i class="fas fa-life-ring text-2xl"></i></div>
                             <div>
                         ...
                         <div class="bg-white border border-gray-200 rounded-xl shadow-md p-6 flex items-start space-x-4">
                            <div class="bg-green-100 bg-linear-to-t from-[#00C6FF] to-[#0084FF] bg-clip-text text-transparent p-3 rounded-full mt-1"><i class="fas fa-handshake text-2xl"></i></div>
                             <div>
                     ...
                     <div class="flex justify-center">
                         <a href="#/contact" class="bg-linear-to-l from-[#00C6FF] to-[#0084FF] text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-700 transition">Hubungi Kami Sekarang</a>
                     </div>
                 </div>
                ...
                <div class="mt-10 md:mt-16 px-4 md:px-10 lg:px-20 pb-10 md:pb-16">
                    ...
                    <div class="flex justify-center mb-6 md:mb-8 overflow-x-auto">
                        <div class="inline-flex p-1 bg-gray-100 rounded-full flex-nowrap whitespace-nowrap">
                            ...
                            <button class="tab-button px-4 md:px-6 py-1 md:py-2 text-xs md:text-sm font-medium rounded-full text-gray-700 hover:bg-gray-200" ="anger">Anger</button>
                    ...
                    <div class="flex justify-center mt-6 md:mt-8">
                        <button class="px-6 md:px-8 py-2 md:py-3 bg-linear-to-l from-[#00C6FF] to-[#0084FF] text-white font-medium rounded-full hover:bg-blue-700 transition text-sm md:text-base">Lihat Lebih Banyak</button>
                    </div>
                </div>
                <footer class="bg-[#0084FF] text-white py-10 md:py-16">
                    <div class="container mx-auto px-6 md:px-20">
                        ...
                        <div class="mt-10 pt-8 border-t border-blue-600 text-center text-sm text-gray-300">
                            © 2025 MyCare AI. Dibuat oleh Kelompok 3 IMK.
                        </div>
                    </div>
                </footer>
            </div>
